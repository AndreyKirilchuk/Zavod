...
{{--        <button class="tovar_optionReviews" onclick="openReviews()">Отзывы (2)</button>--}}
    ...
    <div class="tovar_content">
        <div class="tovar_contentInfo">
            <strong> {{$tovar->name}} </strong>  - представляет собой полный технический аналог чугунного по ГОСТ 5525, имеющий аналогичные габаритные размеры.  Данный продукт применяется для четырехстороннего соединения сантехнического прибора с водопроводной системой для забора холодной воды из трубопровода.
        </div>
